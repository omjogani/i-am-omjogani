...
class ProjectScreen extends StatelessWidget {
  ProjectScreen({required this.isMobile});
  final bool isMobile;
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ScreenTypeLayout(
                  mobile: insertAnimation(columnLayout()),
                  tablet: insertAnimation(columnLayout()),
                  desktop: insertAnimation(rowLayout()),
                ),
                SizedBox(height: 40.0),
                ShowUp(
                  delay: 500,
  ...
  Widget insertAnimation(Widget child) {
    return ShowUp(child: child, delay: 500);
  }
